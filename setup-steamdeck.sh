...
echo ""
echo "Frame cap:"
echo "  IMPORTANT: Do NOT set Steam Quick Access Frame Limit to 30fps."
echo "  SCDA is already a 30fps game. Gamescope at 60Hz frame-doubles it"
echo "  automatically (each xemu frame shown twice = 30fps stable output)."
echo "  A 30fps Steam cap throttles xemu input to 15fps. Leave the frame"
echo "  limit at 60fps (default) or disabled."
echo ""
echo "Gamescope + FSR launch example (Desktop Mode):"
