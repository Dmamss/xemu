...
echo ""
echo "Frame cap (SCDA runs at 30fps):"
echo "  Game Mode: Quick Access (battery icon) → Frame Limit → 30"
echo "  Gamescope bypasses xemu vsync — do NOT enable vsync in xemu settings."
echo ""
echo "Gamescope + FSR launch example (Desktop Mode):"
echo "  gamescope -w 1280 -h 800 -r 60 --fsr-upscaling --framerate-limit 30 -- \\"
