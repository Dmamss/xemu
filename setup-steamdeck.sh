...
echo ""
echo "Frame cap:"
echo "  SCDA runs at 30fps internally — no Steam frame cap needed."
echo "  Leave Quick Access → Frame Limit at 'Off'. Gamescope at 60Hz"
echo "  displays each 30fps frame twice automatically. VSync in xemu stays ON."
echo ""
